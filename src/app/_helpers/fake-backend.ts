...
import { delay, materialize, dematerialize, debounceTime } from 'rxjs/operators';
...
export class FakeBackendInterceptor implements HttpInterceptor {
    ...
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
        ...
        function authenticate() {
            ...
            // authenticate fails if account not found or password is wrong
            ...
            if (accounts.find(x => x.email === account.email)) {
                ...
                setTimeout(() => {
                    alertService.info(`
                        ...
                        <p>If you dont know your password please visit the <a href ='${location.origin}/account/forgot-password'>forgot password</a> page.</p>
                        <div><strong>NOTE:</strong> The fake backend displayed this "email" so you can test without an api. A real backend would send send a email.</div>
                    `, { autoClose: false });
                }, 1000);
        ...
        function verifyEmail() {
            ...
            if (!account) return error('Verification is failed');
